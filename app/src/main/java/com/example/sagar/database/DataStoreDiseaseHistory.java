...
public class DataStoreDiseaseHistory {

    private Context mContext;

    public DataStoreDiseaseHistory(Context context) {
    ...
    public void storeDiseaseInfo(String disease_name, String district,
        ...
        if (delete_table) {
            db.delete("disease_info_previously_seen", null, null);
            db.execSQL("DELETE FROM SQLITE_SEQUENCE WHERE NAME = '" + "disease_info_previously_seen" + "'");
        ...
        if (!notclear) {
            ...
            db.insert("disease_info_previously_seen", null, user_data);
        }
    }
